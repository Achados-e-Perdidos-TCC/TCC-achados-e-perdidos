package com.achadosedevolvidos.auth.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Token malformado/expirado ou usuário não encontrado: não autentica, mas não
            // interrompe a cadeia — quem depender de autenticação será barrado adiante por
